...
public:
  ...
  friend bofstream & operator << ( bofstream &, Boolean );
...
public:
  ...
  friend bifstream & operator >> ( bifstream &, Boolean & );
...
*/
inline bofstream & operator << ( bofstream &fout, Boolean val )
{
     char ch = ( char ) val;
     fout.WriteBytes (( void *)&val, sizeof ( char ), TChar );
     return fout;
...
*/
inline bifstream & operator >> (bifstream &bifs, Boolean& val )
{
     char ch;
