...
public:
    ...
    COLORREF GetBkColor ( void ) { return m_crBack; }
    int     GetPointSize ( void ) { return m_lf.lfHeight / -10; }
    int     GetFontSize ( void ) { return m_lf.lfHeight; }
    COLORREF GetTextColor ( void ) { return m_crText; }
    char *  GetFontName ( void ) { return m_lf.lfFaceName; }
    BOOL    GetFontItalic ( void ) { return m_lf.lfItalic; }
    BOOL    GetFontBold ( void ) { return m_lf.lfWeight == FW_BOLD ? TRUE : FALSE; }
